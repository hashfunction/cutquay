...
export default interface Resources {
  "translation": {
    ...
    "Allow multiple instances of CutQuay to run concurrently? (experimental)": "Allow multiple instances of CutQuay to run concurrently (experimental)",
    "Alt": "Alt",
    "Always": "Always",
    ...
    "Cut mode": "Cut mode",
    "CutQuay project": "CutQuay project",
    "Cutlist": "Cutlist",
    ...
    "Instead of video apparently starting at 0, you can offset by a specified value. This only applies to the preview inside CutQuay and does not modify the file in any way. (Useful for viewing/cutting videos according to timecodes)": "Instead of video apparently starting at 0, you can offset by a specified value. This only applies to the preview inside CutQuay and does not modify the file in any way. (Useful for viewing/cutting videos according to timecodes).",
    ...
    "Losslessly download a whole media file from the specified URL, mux it into an mkv file and open it in CutQuay. This can be useful if you need to download a video from a website, e.g. a HLS streaming video. For example in Chrome you can open Developer Tools and view the network traffic, find the playlist (e.g. m3u8) and copy paste its URL here.": "Losslessly download a whole media file from the specified URL, mux it into an mkv file and open it in CutQuay. This can be useful if you need to download a video from a website, e.g. a HLS streaming video. For example in Chrome you can open Developer Tools and view the network traffic, find the playlist (e.g. m3u8) and copy paste its URL here.",
    ...
    "Not all formats support all track types, and CutQuay is unable to properly cut some track types, so you may have to sacrifice some tracks by disabling them in order to get correct result.": "Not all formats support all track types, and CutQuay is unable to properly cut some track types, so you may have to sacrifice some tracks by disabling them in order to get correct result.",
    ...
    "Press confirm to grant CutQuay access to write the project file (due to App Sandbox restrictions).": "Press confirm to grant CutQuay access to write the project file (due to App Sandbox restrictions).",
    "Preview": "Preview",
    "Previous file": "Previous file",
    "Previous keyframe": "Previous keyframe",
    "Prompts and dialogs": "Prompts and dialogs",
    "Quit CutQuay": "Quit CutQuay",
    ...
    "Shift timestamps so that the first timestamp is 0. (CutQuay default)": "Shift timestamps so that the first timestamp is 0 (CutQuay default).",
    ...
    "Use this for all files until CutQuay is restarted?": "Use this for all files until CutQuay is restarted",
    ...
    "What's new in CutQuay?": "What's new in CutQuay?",
