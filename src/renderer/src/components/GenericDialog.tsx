...
export function useDialog() {
  ...
  const openCutFinishedDialog = useCallback(async ({ filePath, warnings, notices, reportPath }: { filePath: string, warnings: string[], notices: string[], reportPath?: string | undefined }) => {
    ...
    await openExportFinishedDialog({
      ...
      children: (
        <UnorderedList>
          ...
          {reportPath && <li><button type="button" onClick={() => showItemInFolder(reportPath)}>Open report</button></li>}
